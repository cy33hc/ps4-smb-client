...
namespace Windows
{
    ...
    void ConnectionPanel()
    {
        ...
        if (ImGui::Button(id, ImVec2(200, 0)))
        {
            ...
            Dialog::initImeDialog(lang_strings[STR_SERVER], smb_settings->server_ip, 15, ORBIS_TYPE_NUMBER, pos.x, pos.y);
        ...
        if (ImGui::Button(id, ImVec2(190, 0)))
        {
        ...
        if (ImGui::Button(id, ImVec2(140, 0)))
        {
            ...
            ime_field_size = 32;
            ime_callback = SingleValueImeCallback;
            Dialog::initImeDialog(lang_strings[STR_USERNAME], smb_settings->username, 32, ORBIS_TYPE_BASIC_LATIN, pos.x, pos.y);
            gui_mode = GUI_MODE_IME;
        }
        ImGui::SameLine();
        ...
        if (ImGui::Button(id, ImVec2(100, 0)))
        {
            ...
            ime_field_size = 24;
            ime_callback = SingleValueImeCallback;
            Dialog::initImeDialog(lang_strings[STR_PASSWORD], smb_settings->password, 24, ORBIS_TYPE_BASIC_LATIN, pos.x, pos.y);
            gui_mode = GUI_MODE_IME;
        }
        ImGui::SameLine();
